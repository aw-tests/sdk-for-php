...
class Functions extends Service
{
     ...
     */
    public function createExecution(string $functionId, string $body = null, bool $async = null, string $xpath = null, Method $method = null, array $headers = null): array
    {
        $apiPath = str_replace(['{functionId}'], [$functionId], '/functions/{functionId}/executions');
